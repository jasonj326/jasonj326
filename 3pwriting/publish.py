...
<style>
    ...
    /* Typography plugin decorates inline code with literal backticks via ::before/::after.
       They look like typos and can ride along on copy. Needs !important: the Play CDN
       injects its stylesheet after this block, so an equal-specificity rule loses. */
